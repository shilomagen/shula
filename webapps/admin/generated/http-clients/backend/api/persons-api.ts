...
export const PersonsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllPersons: async (xParticipantId: string, page?: number, size?: number, participantId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'xParticipantId' is not null or undefined
            assertParamExists('getAllPersons', 'xParticipantId', xParticipantId)
            const localVarPath = `/api/v1/persons`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getPersonsByParticipant: async (xParticipantId: string, id: string, size?: number, page?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'xParticipantId' is not null or undefined
            assertParamExists('getPersonsByParticipant', 'xParticipantId', xParticipantId)
            // verify required parameter 'id' is not null or undefined
            assertParamExists('getPersonsByParticipant', 'id', id)
...
export const PersonsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllPersons(xParticipantId: string, page?: number, size?: number, participantId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PersonsResponseDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllPersons(xParticipantId, page, size, participantId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PersonsApi.getAllPersons']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async getPersonsByParticipant(xParticipantId: string, id: string, size?: number, page?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PersonsResponseDto>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPersonsByParticipant(xParticipantId, id, size, page, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PersonsApi.getPersonsByParticipant']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const PersonsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllPersons(xParticipantId: string, page?: number, size?: number, participantId?: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<PersonsResponseDto>> {
            return localVarFp.getAllPersons(xParticipantId, page, size, participantId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get a person by ID
         ...
         * @throws {RequiredError}
         */
        getPersonsByParticipant(xParticipantId: string, id: string, size?: number, page?: number, options?: RawAxiosRequestConfig): AxiosPromise<Array<PersonsResponseDto>> {
            return localVarFp.getPersonsByParticipant(xParticipantId, id, size, page, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Index a person\'s face using AWS Rekognition
...
export class PersonsApi extends BaseAPI implements PersonsApiInterface {
     ...
     * @memberof PersonsApi
     */
    public getAllPersons(xParticipantId: string, page?: number, size?: number, participantId?: string, options?: RawAxiosRequestConfig) {
        return PersonsApiFp(this.configuration).getAllPersons(xParticipantId, page, size, participantId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PersonsApi
     */
    public getPersonsByParticipant(xParticipantId: string, id: string, size?: number, page?: number, options?: RawAxiosRequestConfig) {
        return PersonsApiFp(this.configuration).getPersonsByParticipant(xParticipantId, id, size, page, options).then((request) => request(this.axios, this.basePath));
    }
