...
export const GroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [participantId] Filter groups by participant ID
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getAllGroupsWithCounts: async (page?: number, size?: number, minParticipants?: number, maxParticipants?: number, name?: string, participantId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const GroupsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllGroupsWithCounts(page?: number, size?: number, minParticipants?: number, maxParticipants?: number, name?: string, participantId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedGroupsWithCountsResponseDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllGroupsWithCounts(page, size, minParticipants, maxParticipants, name, participantId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const GroupsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllGroupsWithCounts(page?: number, size?: number, minParticipants?: number, maxParticipants?: number, name?: string, participantId?: string, options?: RawAxiosRequestConfig): AxiosPromise<PaginatedGroupsWithCountsResponseDto> {
            return localVarFp.getAllGroupsWithCounts(page, size, minParticipants, maxParticipants, name, participantId, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve details of a specific group by ID
         * @summary Get group details
...
export class GroupsApi extends BaseAPI implements GroupsApiInterface {
     ...
     * @memberof GroupsApi
     */
    public getAllGroupsWithCounts(page?: number, size?: number, minParticipants?: number, maxParticipants?: number, name?: string, participantId?: string, options?: RawAxiosRequestConfig) {
        return GroupsApiFp(this.configuration).getAllGroupsWithCounts(page, size, minParticipants, maxParticipants, name, participantId, options).then((request) => request(this.axios, this.basePath));
    }
